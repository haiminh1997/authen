...
class MenuItemController extends Controller
{
    ...
    public function index(){
        $items = DB::table('menu_items')->paginate(8);
        $items = MenuItemModel::getMenuItemRecursive();
        /**
         * Đây là biến truyền từ controller xuống view
         */
        $data= array();
        $data['menuitems']= $items; // truy cập tên biến là tags trong phần view
    ...
    public function edit($id){
        ...
        $data['types'] = MenuItemModel::getTypeOfMenuItem();
        $data['menus']= MenuModel::all();
        $data['menuitems']=  MenuItemModel::getMenuItemRecusiveExcept($id); //ngắt tất cả bản thân nó và con cháu của nó
...
//        $data['id']= $id;
    ...
    public function update(Request $request, $id){
        ...
        /**
         * Kiểm tra xem có đổi parent id không
         */

...
@section('content')
    ...
    <?php $sale1_image= isset($banner_sale_1->image) ? asset($banner_sale_1->image) : ''; ?>
    <?php $sale2_image= isset($banner_sale_2->image) ? asset($banner_sale_2->image) : ''; ?>
    <?php $sale3_image= isset($banner_sale_3->image) ? asset($banner_sale_3->image) : ''; ?>
    <?php $sale4_image= isset($banner_sale_4->image) ? asset($banner_sale_4->image) : ''; ?>
    <?php $sale5_image= isset($banner_sale_5->image) ? asset($banner_sale_5->image) : ''; ?>

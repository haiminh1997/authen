            ...
            <div class="about-info">
                <div class="col-md-8 about-grids">
                    ...
                    <div class="about-w3ls-row">
                        ...
                        <ul id="flexiselDemo3">
                            <li>
                                <img src="{{ asset('frontend_assets/images/a1.jpg') }}" class="img-responsive" alt="" />
                            </li>
                            <li>
                                <img src="{{ asset('frontend_assets/images/a2.jpg') }}" class="img-responsive" alt="" />
                            </li>
                            <li>
                                <img src="{{ asset('frontend_assets/images/a3.jpg') }}" class="img-responsive" alt="" />
                            </li>
                            <li>
                                <img src="{{ asset('frontend_assets/images/a4.jpg') }}" class="img-responsive" alt="" />
                            </li>
                        </ul>
        ...
        <div class="container">
            ...
            <div class="team-grids">
                <div class="col-md-3 team-grid">
                    <div class="team-img">
                        <img src="{{ asset('frontend_assets/images/t1.jpg') }}" class="img-responsive" alt=" " />
                ...
                <div class="col-md-3 team-grid">
                    <div class="team-img">
                        <img src="{{ asset('frontend_assets/images/t3.jpg') }}" class="img-responsive" alt=" " />
                        <figcaption class="overlay">
                            <div class="social-icon">
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-dribbble" aria-hidden="true"></i></a>
                ...
                <div class="col-md-3 team-grid">
                    <div class="team-img">
                        <img src="{{ asset('frontend_assets/images/t2.jpg') }}" class="img-responsive" alt=" " />
                        <figcaption class="overlay">
                            <div class="social-icon">
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-dribbble" aria-hidden="true"></i></a>
                ...
                <div class="col-md-3 team-grid">
                    <div class="team-img">
                        <img src="{{ asset('frontend_assets/images/t4.jpg') }}" class="img-responsive" alt=" " />
                        <figcaption class="overlay">
                            <div class="social-icon">
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-dribbble" aria-hidden="true"></i></a>

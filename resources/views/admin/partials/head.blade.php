...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <script>
        $(document).ready(function() {
            ...
            /* tinymce.init({
                // dành cho tinymce
                selector: 'textarea.mytinymce', // những thẻ textarea có class là mytinymce
                height : 400,
                plugins: [
            ...
            // dành cho UniSharp/laravel-filemanager quản lý file
            var editor_config = {
                path_absolute : "http://localhost/authen/public/",

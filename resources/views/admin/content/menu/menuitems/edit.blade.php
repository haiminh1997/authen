        ...
        <div class="form-three widget-shadow">
            <form name="menu" action="{{url('admin/menuitems/'.$menu->id)}}" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="sort" class="form-control1" id="focusedinput" value="{{$menu->sort}}">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div id="type-7" class="form-group menu-type">
                    ...
                    <div class="col-sm-8">
                        <input name="params_7"  class="form-control1" value="{{$params['params_7']}}" id="focusedinput" placeholder="Ex: www.google.com">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="icon" value="{{$menu->icon}}" class="form-control1" id="focusedinput" placeholder="Icon">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select name="parent_id">
                            ...
                            @foreach($menuitems as $menuitem)
                                ...
                                <option value="{{$menuitem['id']}}" {{$selected}}>{{str_repeat('-',$menuitem['level']).' '.$menuitem['name']}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>

...
@section('content')
    ...
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            @endif
            <form name="category" action="{{ url('admin/content/post/'.$post->id) }}" method="post" class="form-horizontal">
                @csrf
                <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">Tên bài viết</label>
                    <div class="col-sm-8">
                        <input type="text" name="name" class="form-control1" id="focusedinput" value="{{ $post->name }}" placeholder="Tên sản phẩm">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select name="cat_id">
                            ...
                            {{--$cats lấy từ index trong ShoppostController--}}
                            @foreach($cats as $cat)
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="slug" class="form-control1" id="focusedinput" value="{{ $post->slug }}" placeholder="Slug">
                    </div>
                </div>
                <div class="form-group">

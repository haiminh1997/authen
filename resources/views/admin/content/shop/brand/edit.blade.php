...
@section('content')
    ...
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            @endif
            <form name="category" action="{{ url('admin/shop/brand/'.$brand->id) }}" method="post" class="form-horizontal">
                @csrf
                <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">Tên nhãn hiệu</label>
                    <div class="col-sm-8">
                        <input type="text" name="name" class="form-control1" id="focusedinput" value="{{ $brand->name }}" placeholder="Tên sản phẩm">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="link" value="{{ $brand->link }}" class="form-control1" id="focusedinput" placeholder="link">
                    </div>
                </div>
